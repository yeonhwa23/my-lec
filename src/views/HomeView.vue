...
.hv-hero {
  ...
  overflow: hidden; padding: 110px 0 90px;
}
...
.o1 {
  ...
  background: radial-gradient(circle, rgba(120,121,192,0.22) 0%, rgba(102,103,171,0.08) 50%, transparent 70%);
...
.hb-grid {
  ...
  background-image:
    linear-gradient(rgba(180,160,255,0.05) 1px, transparent 1px),
    linear-gradient(90deg, rgba(180,160,255,0.05) 1px, transparent 1px);
  background-size: 52px 52px;
  mask-image: radial-gradient(ellipse 85% 85% at 55% 45%, black 40%, transparent 100%);
}
.hb-vignette {
  position: absolute; inset: 0;
  background: radial-gradient(ellipse 80% 80% at 50% 50%, transparent 50%, rgba(12,11,26,0.6) 100%);
}
...
.hl-line.em em {
  font-style: normal;
  background: linear-gradient(135deg, #DDD6FE 0%, #A78BFA 45%, #8889C4 100%);
...
.hl-btn-main {
  ...
  padding: 14px 28px;
  background: linear-gradient(135deg, #9A9BD0, #7879C0, #6667AB);
  color: #fff; border-radius: 14px; font-size: 14.5px; font-weight: 600;
  text-decoration: none; transition: all 0.28s;
  box-shadow: 0 0 32px rgba(120,121,192,0.32), inset 0 1px 0 rgba(255,255,255,0.18);
}
...
.hl-btn-ghost {
  ...
  padding: 14px 24px; color: rgba(220,218,240,0.42);
  border: 1px solid rgba(180,160,255,0.14); border-radius: 14px;
  font-size: 14.5px; font-weight: 400; text-decoration: none; transition: all 0.25s;
}
...
.hl-toast {
  ...
  border-left: 2px solid #8889C4;
  border-radius: 12px; padding: 10px 14px;
  font-size: 12px; color: rgba(220,218,240,0.65); width: 285px;
  box-shadow: 0 8px 32px rgba(0,0,0,0.4), 0 0 20px rgba(120,121,192,0.1);
  backdrop-filter: blur(16px);
  animation: toastIn 0.4s ease 0.3s both, cardBob 6s ease-in-out 0.5s infinite;
}
...
.hl-stat {
  ...
  background: linear-gradient(145deg, #8889C4, #7879C0, #6667AB);
  border-radius: 16px; padding: 14px 20px; text-align: center;
  animation: cardBob 6s ease-in-out 3.2s infinite;
  box-shadow: 0 8px 32px rgba(120,121,192,0.4), inset 0 1px 0 rgba(255,255,255,0.2);
}
...
.sec-chip {
  ...
  background: rgba(180,160,255,0.1); color: #C4B5FD;
  border: 1px solid rgba(180,160,255,0.18);
...
.bc {
  ...
  position: relative; transition: transform 0.35s, box-shadow 0.35s;
  overflow: hidden;
}
.bc:hover { transform: translateY(-6px); }
.bc-lg {
  grid-row: 1/3;
  background: linear-gradient(160deg, #1D1B3A 0%, #15133A 50%, #12122B 100%);
...
.bc-glow {
  ...
  background: radial-gradient(circle, rgba(120,121,192,0.14), transparent 70%);
...
.bc-ico {
  ...
  font-size: 22px;
  background: linear-gradient(145deg, rgba(180,160,255,0.18), rgba(120,121,192,0.1));
  color: #C4B5FD;
  border: 1px solid rgba(180,160,255,0.18);
}
...
.fs-feat {
  background: linear-gradient(155deg, #1D1B3A, #15133A, #13122A);
...
.cta-btn {
  ...
  padding: 16px 44px;
  background: linear-gradient(135deg, #9A9BD0, #7879C0, #6667AB);
  color: #fff; border-radius: 16px; font-size: 15px; font-weight: 600;
  text-decoration: none; transition: all 0.3s;
  box-shadow: 0 0 40px rgba(120,121,192,0.35), inset 0 1px 0 rgba(255,255,255,0.18);
}
